...
| # | Dans le fichier model/tasks.js, ajouter un champ “status” au schéma des tasks qui peut prendre la valeur “assigned” ou “notAssigned”. Lorsqu’une tâche a le statut “assigned”, toutes les fonctionnalités reliées aux tâches lui sont applicables (drag and drop, etc). Lorsqu’une tâche a pour statut "notAssigned" il n’est plus possible de la drag and drop ni de cocher des éléments de la checklist de sa DOD. | 1h | US25 | / | TODO | DEV | / |
...
| # | Implémenter dans le fichier test/E2E/task.test.js un test qui vérifie que lorsque l’on change le membre assigné à une tâche, on ne peut plus drag and drop cette tâche ni cocher des éléments de la checklist de sa DOD. | 30min | US25 | / | TODO | TES | / |
