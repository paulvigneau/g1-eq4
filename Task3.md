...
| #120 | Dans le fichier services/taskService.js, ajouter la fonction addTask(projectId, description, type, cost, member, dependancies[ ], usLinked [ ]) permettant d'ajouter une tâche dans la base de données et ce dans la phase d'avancement TODO. | 30min | US19 | / | TODO | DEV | / |
