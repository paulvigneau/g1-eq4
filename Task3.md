...
| # | Créer le service updateTask dans services/taskService.js qui au même titre de addTask (cf. #120) va prendre en paramètre les informations d'une tâche mais va cette fois-ci modifier la tâche correspondante. Donc il faut aussi passer en paramètre l'id de la tâche à éditer. | 45min | US23 | / | TODO | DEV | / |
...
| # | Dans le fichier model/tasks.js, ajouter un champ “status” au schéma des tasks qui peut prendre la valeur “assigned” ou “notAssigned”. Lorsqu’une tâche a le statut “assigned”, il est possible de cocher les éléments de s DOD. Lorsqu’une tâche a pour statut "notAssigned" il n’est plus possible de cocher les éléments de la checklist de sa DOD. | 1h | US25 | / | TODO | DEV | / |
| # | Ajouter dans la fonction updateTask du fichier services/taskService.js la mise à jour du statut d’une tâche. Lorsque le champ “member” d’une task est remplacé par “Non assigné”, la task doit avoir comme statut “notAssigned”, sinon “assigned”. | 25min | US25 | / | TODO | DEV | / |
| # | Dans le fichier new-task.ejs, ajouter à la liste déroulante du champ “membre” le choix “Non assigné”. | 15min | US25 | / | TODO | DEV | / |
| # | Implémenter dans le fichier test/E2E/task.test.js un test qui vérifie que lorsque l’on change le membre assigné à une tâche, on ne peut plus cocher les éléments de la checklist de sa DOD. | 30min | US25 | / | TODO | TES | / |
| # | Implémenter dans le fichier test/Unit/task.test.js un test  qui vérifie que lorsque l’on modifie le membre assigné à une tâche par un membre valide à l’aide de la fonction updateTask, alors le champ “status” de la task a pour valeur “assigned”. | 30min | US25 | / | TODO | TEST | / |
| # | Implémenter dans le fichier test/Unit/task.test.js un test  qui vérifie que lorsque l’on modifie le membre assigné à une tâche par “Non assigné” à l’aide de la fonction updateTask, alors le champ “status” de la task a pour valeur “notAssigned”. | 30min | US25 | / | TODO | TEST | / |
| # | Lorsqu’une requête POST /projects/:projectId/tasks (resp. PUT) est envoyée, si le membre assigné à la tâche est modifié par un autre membre valide, il faut envoyer un mail au nouveau membre responsable de la tâche. Si le membre assigné à la tâche est modifié par “Non assigné” alors un mail doit être envoyé au membre auquel la tâche vient d’être retirée. Dans les deux cas, le mail devra contenir le nom du projet, la date de mise à jour de l'assignation du membre à la tâche et l’Id de la tâche. | 1h | US26 | / | TODO | DEV | / |
| # | Dans le fichier views/view-task.ejs, ajouter une checklist correspondant à la DOD de la tâches. | 15min | US27 | / | TODO | DEV | / |
| # | Créer la route PUT /projects/:projectId/tasks/:taskId/dod dans le fichier /routes/tasks-routes.js qui appelle la fonction updateDod pour mettre à jour la DOD de la task ayant pour id taskId. En cas d’erreur, le code status 400 sera renvoyé. | 25min | US28 | / | TODO | DEV | / |
| # | Dans le fichier views/view-task.ejs, ajouter l’envoie d’une requête PUT /projects/:projectId/tasks/:taskId/dod lorsque l’état de la DOD (checklist) est modifié. | 25min | US28 | / | TODO | DEV | / |
| # | Dans le fichier services/taskService.js, ajouter une fonction updateDod qui met à jour la DOD d’une task dans la base de données. Si tous les éléments de la DOD sont validés et que toutes les tâches dont dépend la tâche actuelle ont pour état d’avancement “DONE”, alors la tâche doit également passer à l’état d’avancement “DONE”. | 1h | US28 | / | TODO | DEV | / |
| # | Implémenter dans le fichier test/E2E/task.test.js un test qui vérifie que lorsque l’on coche toutes les éléments de la DOD d’une tâche et que toutes les tâches dont elle dépend on pour état d’avancement “DONE”, alors l’état d’avancement de la tâche est automatiquement passé à “DONE”. | 30min | US28 | / | TODO | TEST | / |
